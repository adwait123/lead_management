  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="border-0 shadow-lg bg-gradient-to-r from-emerald-50 to-green-50">
        ...
        <CardContent>
          <p className="text-gray-600 mb-4">Use these variables in your prompt to personalize agent responses with dynamic lead and project data:</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg p-4 border border-emerald-200">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center"><code className="bg-emerald-50 px-2 py-1 rounded text-xs font-mono text-emerald-700 mr-2">{{first_name}}</code><span className="text-gray-600">Lead's first name</span></div>
                <div className="flex items-center"><code className="bg-emerald-50 px-2 py-1 rounded text-xs font-mono text-emerald-700 mr-2">{{last_name}}</code><span className="text-gray-600">Lead's last name</span></div>
                <div className="flex items-center"><code className="bg-emerald-50 px-2 py-1 rounded text-xs font-mono text-emerald-700 mr-2">{{full_name}}</code><span className="text-gray-600">Complete name</span></div>
                <div className="flex items-center"><code className="bg-emerald-50 px-2 py-1 rounded text-xs font-mono text-emerald-700 mr-2">{{email}}</code><span className="text-gray-600">Email address</span></div>
                <div className="flex items-center"><code className="bg-emerald-50 px-2 py-1 rounded text-xs font-mono text-emerald-700 mr-2">{{phone}}</code><span className="text-gray-600">Phone number</span></div>
                <div className="flex items-center"><code className="bg-emerald-50 px-2 py-1 rounded text-xs font-mono text-emerald-700 mr-2">{{company}}</code><span className="text-gray-600">Company name</span></div>
                <div className="flex items-center"><code className="bg-emerald-50 px-2 py-1 rounded text-xs font-mono text-emerald-700 mr-2">{{source}}</code><span className="text-gray-600">Lead source (Yelp, website, etc.)</span></div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-4 border border-blue-200">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center"><code className="bg-blue-50 px-2 py-1 rounded text-xs font-mono text-blue-700 mr-2">{{services_needed}}</code><span className="text-gray-600">Requested services</span></div>
                <div className="flex items-center"><code className="bg-blue-50 px-2 py-1 rounded text-xs font-mono text-blue-700 mr-2">{{service_requested}}</code><span className="text-gray-600">Primary service request</span></div>
                <div className="flex items-center"><code className="bg-blue-50 px-2 py-1 rounded text-xs font-mono text-blue-700 mr-2">{{budget_range}}</code><span className="text-gray-600">Budget range</span></div>
                <div className="flex items-center"><code className="bg-blue-50 px-2 py-1 rounded text-xs font-mono text-blue-700 mr-2">{{timeline}}</code><span className="text-gray-600">Project timeline</span></div>
                <div className="flex items-center"><code className="bg-blue-50 px-2 py-1 rounded text-xs font-mono text-blue-700 mr-2">{{project_details}}</code><span className="text-gray-600">Additional project info</span></div>
                <div className="flex items-center"><code className="bg-blue-50 px-2 py-1 rounded text-xs font-mono text-blue-700 mr-2">{{special_requirements}}</code><span className="text-gray-600">Special requirements</span></div>
                <div className="flex items-center"><code className="bg-blue-50 px-2 py-1 rounded text-xs font-mono text-blue-700 mr-2">{{survey_responses}}</code><span className="text-gray-600">Survey Q&A pairs</span></div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-4 border border-orange-200">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center"><code className="bg-orange-50 px-2 py-1 rounded text-xs font-mono text-orange-700 mr-2">{{city}}</code><span className="text-gray-600">Project city</span></div>
                <div className="flex items-center"><code className="bg-orange-50 px-2 py-1 rounded text-xs font-mono text-orange-700 mr-2">{{state}}</code><span className="text-gray-600">Project state</span></div>
                <div className="flex items-center"><code className="bg-orange-50 px-2 py-1 rounded text-xs font-mono text-orange-700 mr-2">{{postal_code}}</code><span className="text-gray-600">ZIP/postal code</span></div>
                <div className="flex items-center"><code className="bg-orange-50 px-2 py-1 rounded text-xs font-mono text-orange-700 mr-2">{{location}}</code><span className="text-gray-600">Postal code (alias)</span></div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-4 border border-purple-200">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center"><code className="bg-purple-50 px-2 py-1 rounded text-xs font-mono text-purple-700 mr-2">{{agent_name}}</code><span className="text-gray-600">Agent's name</span></div>
                <div className="flex items-center"><code className="bg-purple-50 px-2 py-1 rounded text-xs font-mono text-purple-700 mr-2">{{business_name}}</code><span className="text-gray-600">Business name</span></div>
                <div className="flex items-center"><code className="bg-purple-50 px-2 py-1 rounded text-xs font-mono text-purple-700 mr-2">{{session_goal}}</code><span className="text-gray-600">Session objective</span></div>
                <div className="flex items-center"><code className="bg-purple-50 px-2 py-1 rounded text-xs font-mono text-purple-700 mr-2">{{trigger_type}}</code><span className="text-gray-600">What triggered agent</span></div>
                <div className="flex items-center"><code className="bg-purple-50 px-2 py-1 rounded text-xs font-mono text-purple-700 mr-2">{{attachment_count}}</code><span className="text-gray-600">Number of files provided</span></div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg p-4">
            <h4 className="font-semibold text-gray-900 mb-3">Example Usage in Prompts:</h4>
            <div className="space-y-3 text-sm">
              <div className="bg-white rounded p-3 border-l-4 border-emerald-400">
                <div className="font-mono text-emerald-700 mb-1">"Hi {{first_name}}! I see you're interested in {{services_needed}} in {{city}}."</div>
                <div className="text-gray-600 text-xs">→ "Hi John! I see you're interested in Kitchen Remodeling in Beverly Hills."</div>
              </div>
              <div className="bg-white rounded p-3 border-l-4 border-blue-400">
                <div className="font-mono text-blue-700 mb-1">"Based on your {{budget_range}} budget and {{timeline}} timeline..."</div>
                <div className="text-gray-600 text-xs">→ "Based on your $50,000 - $100,000 budget and 3-6 months timeline..."</div>
              </div>
              <div className="bg-white rounded p-3 border-l-4 border-purple-400">
                <div className="font-mono text-purple-700 mb-1">"I'm {{agent_name}} from {{business_name}}. I can help with {{service_requested}}."</div>
                <div className="text-gray-600 text-xs">→ "I'm Sarah from Home Pro Services. I can help with Kitchen Remodeling."</div>
              </div>
            </div>
          </div>
        </CardContent>
